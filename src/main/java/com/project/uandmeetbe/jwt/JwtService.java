...
public class JwtService {
    ...
    @Transactional
    public void login(Token tokenDto, String memberAgent){
        ...
        RefreshToken refreshToken = RefreshToken.builder()
                                                ...
                                                .build();
        String loginEmail = refreshToken.getKeyEmail();
        if(refreshTokenRepository.existsByKeyEmailAndMemberAgent(loginEmail, memberAgent)){
            log.info("기존의 존재하는 refresh 토큰 삭제");
            refreshTokenRepository.deleteByKeyEmailAndMemberAgent(loginEmail, memberAgent);
        }
